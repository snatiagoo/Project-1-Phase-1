...
export default function Form(){
    return (
        <main>
            ...
            <div>
                <input className = "border border-gray-400 rounded p-2 px-4 w-120 "  name = "title" />
            </div>
                <textarea  className = "border border-gray-400 rounded p-2 py-3 w-250" name = "description" />
